...
public class AgenciaService {
    ...
    public void validar(AgenciaPOJO agencia) throws EntidadeOuClasseEmBrancoOuNaoInformadaException,
    ...
    public AgenciaPOJO findById(int id) throws SQLException, TamanhoMaximoDoCampoExcedidoException, Exception {
    ...
    public void insert(AgenciaPOJO agencia) throws SQLException, EntidadeOuClasseEmBrancoOuNaoInformadaException, CampoEspecificoNaoInformadoException, TamanhoMaximoDoCampoExcedidoException, ValorInvalidoException {
        validar(agencia);
        AgenciaDAO agenciaDAO = new AgenciaDAO();
        agenciaDAO.insert(agencia);
    }

    public void update(AgenciaPOJO agencia) throws SQLException, EntidadeOuClasseEmBrancoOuNaoInformadaException, CampoEspecificoNaoInformadoException, TamanhoMaximoDoCampoExcedidoException, ValorInvalidoException {
        validar(agencia);
        AgenciaDAO agenciaDAO = new AgenciaDAO();
